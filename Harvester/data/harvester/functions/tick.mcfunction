...
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=wheat_seeds,scores={rand_2=1..3}] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:wheat[age=7] if entity @s[scores={sneak_time=1..}] run clear touchportal minecraft:wheat_seeds 1
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=wheat_seeds,scores={rand_2=4}] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:wheat[age=7] if entity @s[scores={sneak_time=1..}] run clear touchportal minecraft:wheat_seeds 2
...
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=potato,scores={rand_2=1..3}] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:potatoes[age=7] if entity @s[scores={sneak_time=1..}] run clear touchportal minecraft:potato 1
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=potato,scores={rand_2=4}] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:potatoes[age=7] if entity @s[scores={sneak_time=1..}] run clear touchportal minecraft:potato 2
...
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=!potato] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:wheat[age=7] if entity @s[scores={sneak_time=1..}] run setblock ~ ~1 ~ minecraft:air destroy
...
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=carrot,scores={rand_2=1..3}] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:carrots[age=7] if entity @s[scores={sneak_time=1..}] run clear touchportal minecraft:carrot 1
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=carrot,scores={rand_2=4}] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:carrots[age=7] if entity @s[scores={sneak_time=1..}] run clear touchportal minecraft:carrot 2
...
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=!carrot] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:wheat[age=7] if entity @s[scores={sneak_time=1..}] run setblock ~ ~1 ~ minecraft:air destroy
...
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=beetroot_seeds,scores={rand_2=1..3}] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:beetroots[age=3] if entity @s[scores={sneak_time=1..}] run clear touchportal minecraft:beetroot_seeds 1
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=beetroot_seeds,scores={rand_2=4}] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:beetroots[age=3] if entity @s[scores={sneak_time=1..}] run clear touchportal minecraft:beetroot_seeds 2
...
execute in minecraft:overworld as @a[tag=diamond_hoe,tag=!beetroot_seeds] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:wheat[age=7] if entity @s[scores={sneak_time=1..}] run setblock ~ ~1 ~ minecraft:air destroy
