...
execute as @a[gamemode=survival,tag=diamond_hoe,tag=!beetroot_seeds] at @s if block ~ ~ ~ minecraft:farmland if block ~ ~1 ~ minecraft:beetroots[age=3] if entity @s[scores={sneak_time=1..}] run setblock ~ ~1 ~ minecraft:air destroy
